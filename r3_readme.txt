...
Major Changes
* Bag-of-words content added to email, http, and file tables
* Organizational structure added, affecting email graph
* Weekend and holiday activity taken into account
* Log of file copies to removable media added
...
* Weekends and holidays are included as days when fewer people work.
* Due to a bug, weekday holidays are not included in Release 3 Dataset 1, but are included in Dataset 2.
...
email.csv
* Fields: id, date, to, from, size, attachment_count, content
...
* Release 3 Dataset 1 takes weekends, but not holidays, into account.
